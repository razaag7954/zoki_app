...
import { getAirportList, getAvailableFlights } from 'crud'
// import Pagination from '@material-ui/lab/Pagination';
import AsyncSelect from 'react-select/async';
import CircularProgress from '@material-ui/core/CircularProgress';
import FlightCard from './flightCard'

function FlightsSearchResults({ setFlightRender, setNewRender }) {
        ...
        <>
            ...
            <div className='row col-lg-9 mt-3 mb-1' style={{ fontSize: 16 }}>
                    <div className='col-lg-6'>
                        <div className='row'>
                            ...
                            <div className='col-lg-4 p-0 mb-0'>
                                <p className='mb-0'>
                                    <input required onChange={(e) => setType(e.target.value)} type='radio' value="one" name="ticket-type" className='mr-2' checked={type == 'one'}/>
                                    One Way
                                </p>
                            </div>
                            <div className='col-lg-4 p-0 mb-0'>
                ...
                <div className='row mt-3 mb-1' style={{ fontSize: 12 }}>
                    ...
                    <div className='col-lg-2 px-1'>
                        <div className='w-100'>
                            ...
                            <input type='date' min={new Date().toISOString().split('T')[0]} required value={returnDate} onChange={(e) => setReturnDate(e.target.value)} className='tab-input form-control p-2 shadow-right text-secondary w-100' placeholder='New York (Any)' disabled={type === 'one'}/>
                        </div>
                    </div>
                </div>
                <div className='row mt-3 mb-1' style={{ fontSize: 12 }}>
                    ...
                    {/* <div className='col-lg-3 px-1'>
                        <div className='w-100'>
                            <p className='mb-1'> Youth(12 - 15) </p>
                            <select value={youth} onChange={(e) => setYouth(e.target.value)} className='tab-input form-control p-2 shadow-right text-secondary w-100'>
                                <option value="" disabled selected hidden>No. of Youth</option>
                                <option> 1 </option>
                                <option> 2 </option>
                                <option> 3 </option>
                                <option> 4 </option>
                    ...
                    {/* <div className='col-lg-3 px-1'>
                        <div className='w-100 position-relative'>
                            <p className='mb-1'> Preferred Airline </p>
                            <Select isLoading placeholder='Airline' onChange={(s) => setAirline(s.value)} className='tab-input border-0 shadow-right text-secondary w-100' options={options} />
                            <input
                                tabIndex={-1}
                                autoComplete="off"
                                className='position-absolute'
                    ...
                    <div className='col-lg-3 px-1'>
                        <div className='w-100'>
                            <p className='mb-1'> Travel Class </p>
                            <Select isLoading placeholder='Class' onChange={(s) => setTravelClass(s.value)} className='tab-input border-0 shadow-right text-secondary w-100' options={options} />
                            <input
                                tabIndex={-1}
                                autoComplete="off"
                                className='position-absolute'
                    ...
                    <div className='col-lg-3 px-1'>
                        <div className='w-100'>
                            ...
                            <Select isLoading placeholder='Currency' onChange={(s) => setCurrency(s.value)} className='tab-input border-0 shadow-right text-secondary w-100' options={options} />
                            <input
                                tabIndex={-1}
                                autoComplete="off"
                                className='position-absolute'
                ...
                <div className='row col-lg-9 mt-3 mb-1' style={{ fontSize: 16 }}>
                    ...
                    {/* <div className='col-lg-3'>
                        <div className='form-check'>
                            <input value={flexible} onChange={(e) => setFlexible(e.target.value)} className='form-check-input' type='checkbox' id='flexCheckDefault' />
                            <label className='form-check-label'>
                                <p className=' p-0 mb-0' style={{ fontSize: 16, color: 'black' }}> Flexible Tickets Only </p>
                            </label>
                        </div>
                    </div> */}
                </div>
                            ...
                            <div className='container pt-3'>
                                {
                                    offers.map((o, i) => {
                                        return (
                                            <FlightCard setFlightRender={setFlightRender} adult={adult} children={children} infant={infant} from={offersFrom} to={offersTo} data={o} key={i} />
                                        )
                                    })
                                }
